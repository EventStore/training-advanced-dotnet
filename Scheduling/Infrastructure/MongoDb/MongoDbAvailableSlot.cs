...
{
    public class MongoDbAvailableSlot : AvailableSlot
    {
        public bool IsBooked { get; set; }

        protected bool Equals(MongoDbAvailableSlot other)
        {
            return DayId == other.DayId && Date.Equals(other.Date) &&
                   StartTime.ToString().Equals(other.StartTime.ToString()) && Duration.Equals(other.Duration) &&
